    ...
    <script type="text/javascript" src="/Test/library/jquery/jquery-1.4.js"></script>
     <script>         
      function del(xw_id){
    	  ...
    	  window.location="/Test/index.php/Admin/ModList/del/xw_id/"+xw_id;
      }
  ...
  hello();
      ...
      <div class="rightDiv">
        ...
        <table border="1" align="center" width="700" cellpadding="0" cellspacing="0">
          ...
          <?php if(is_array($newsarticles)): $i = 0; $__LIST__ = $newsarticles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr height="25">
            <td><?php echo ($v["xw_id"]); ?></td>
            <td><?php echo ($v["xw_dateandtime"]); ?></td>
            <td><?php echo ($v["xw_writer"]); ?></td>
            <td align="left"><?php echo ($v["xw_title"]); ?></a></td>
            
            <td><a href="#" onclick='del(<?php echo ($v["xw_id"]); ?>)'>删除</a></td>
