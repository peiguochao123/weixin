  ...
  <head>
    ...
    <script>         
      function del(ly_Id){
    	  ...
    	  window.location="/Test/index.php/Admin/Message/del/ly_Id/"+ly_Id;
      }
      ...
      <!-- 右侧页面内容 -->
       <div class="rightDiv">
        ...
        <table border="1" align="center" width="700" cellpadding="0" cellspacing="0">
          ...
          <?php if(is_array($message)): $i = 0; $__LIST__ = $message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr height="25">
            <td><?php echo ($v["ly_name"]); ?></td>
            <td><?php echo ($v["ly_email"]); ?></td>
            <td><?php echo ($v["ly_phone"]); ?></td>
            <td><?php echo ($v["ly_body"]); ?></td>
            
            
            <td><a href="#" onclick='del(<?php echo ($v["ly_id"]); ?>)'>删除</a></td>
