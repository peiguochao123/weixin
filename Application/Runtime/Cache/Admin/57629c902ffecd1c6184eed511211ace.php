...
<script  type=text/javascript> 
  ...
  hello();
      ...
      <div class="rightDiv">
        <br>
        <form name="frm" method="post" action="<?php echo U('Admin/AddList/add');?>" enctype="multipart/form-data" onsubmit="return checkAdd()">
        <table class="addListTb" bgcolor="#DCDCDC" border="0" align="center" width="700">
          <tr>
            <td>新闻标题：</td>
