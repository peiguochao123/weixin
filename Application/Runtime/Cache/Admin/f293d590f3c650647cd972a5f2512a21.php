  ...
  <head>
    ...
    <script type="text/javascript" src="/Test/library/jquery/jquery-1.4.js"></script>
     ...
     function del(jj_Id){
    	  ...
    	  window.location="/Test/index.php/Admin/Modgsjj/del/jj_Id/"+jj_Id;
      }
       
      //点击了页码的超链接
      function getPage(currentPage)
      {
          document.frm.action = "/Test/index.php/ModNews/index/currentPage/"+currentPage;
          document.frm.submit();
      }
    </script>
  </head>
...
<div class="menuDiv">
  ...
  <div id="menuDiv5"><a href="<?php echo U('Admin//Index/index');?>">返回首页</a></div>
       ...
       <!-- 当前位置 -->
    <div class="locationDiv">&nbsp;: 后台管理 : 修改公司简介</div>
    <!-- 正文内容 -->
  ...
  hello();
      ...
      <div class="rightDiv">
        ...
        <table border="1" align="center" width="700" cellpadding="0" cellspacing="0">
          <tr height="30" width="700" style="font-weight:bold;">
            <td align="center" width="600" >公司简介</td>
            <td align="center">操作</td>
          </tr>
          <?php if(is_array($gsjj)): $i = 0; $__LIST__ = $gsjj;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr height="50">
            <td width="600"><?php echo ($v["jj_content"]); ?></td>
            <td><a href="<?php echo U('Admin/ModGsjj/del');?>" onclick="del(<?php echo ($v["jj_Id"]); ?>)">删除</a></td>
