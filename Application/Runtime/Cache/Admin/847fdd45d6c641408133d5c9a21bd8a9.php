...
<script  type=text/javascript> 
  ...
  hello();
      ...
      <!-- 右侧页面内容 -->
      <div class="rightDiv">
        <form name="frm" method="post" action="<?php echo U('Admin/AddGsjj/add');?>" enctype="multipart/form-data" onsubmit="return checkAdd()">
        <table class="addGsjjTb" bgcolor="#DCDCDC" border="0" align="center" width="700">
          <tr>
