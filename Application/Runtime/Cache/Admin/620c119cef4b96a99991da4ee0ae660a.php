  ...
  hello();
      ...
      <div class="rightDiv">
        ...
        <table class="addLianxiTb" bgcolor="#DCDCDC" border="0" align="center" width="700">
          ...
          <tr>
            <td>联系人：</td>
            <?php if(is_array($contact)): $i = 0; $__LIST__ = $contact;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><td><?php echo ($v["lx_name"]); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
          </tr>
          <tr>
            <td>联系电话：</td>
