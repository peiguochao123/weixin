...
$("#jdAdBtn").html(htmlAdBtn).find("a").powerSwitch({
	...
	<div class="mr"><!-- 主体右侧开始 -->
		...
		<div class="mrnr1">
		<?php if(is_array($gcal)): $i = 0; $__LIST__ = $gcal;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><dt>
				<a href="/Test/index.php/Home/Pro/index/al_id/<?php echo ($v["al_id"]); ?>.html">
					<img src="/Test/Public/uploads/<?php echo ($v["imagepath"]); ?>" border="0" />
				</a>
				</dt>
				<!-- <dd> -->
						 <?php echo ($v["al_name"]); ?>&nbsp;
					面积:<?php echo ($v["al_area"]); ?>&nbsp;
					风格:<?php echo ($v["al_style"]); ?>&nbsp;
					作者:<?php echo ($v["al_author"]); ?><br />
						 <?php echo ($v["al_content"]); ?>
				<!-- </dd> -->
