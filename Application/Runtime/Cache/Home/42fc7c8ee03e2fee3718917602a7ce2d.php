...
<div class="mr"><!-- 主体右侧开始 -->
<div class="mbrbt"><img src="/Test/Public/images/news.gif" width="690" height="36" /></div>
<div class="mrbtnr"><!-- 主体右侧内容开始 -->
<div class="news">

<?php if(is_array($newsarticles)): $i = 0; $__LIST__ = $newsarticles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><dt><a href="/Test/index.php/Home/Listxq/index/xw_id/<?php echo ($v["xw_id"]); ?>.html"><?php echo ($v["xw_title"]); ?></a></dt>
<dd><?php echo ($v["xw_dateandtime"]); ?></dd><?php endforeach; endif; else: echo "" ;endif; ?>
