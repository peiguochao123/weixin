...
<div class="mr"><!-- 主体右侧开始 -->
<div class="mbrbt"><img src="/Test/Public/images/zpbt.gif" width="690" height="36" /></div>
...
<?php if(is_array($recruitment)): $i = 0; $__LIST__ = $recruitment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
		<td><?php echo ($v["zp_position"]); ?></td>
		<td><?php echo ($v["zp_experience"]); ?></td>
		<td><?php echo ($v["zp_schooling"]); ?></td>
		<td><?php echo ($v["zp_wage"]); ?></td>
