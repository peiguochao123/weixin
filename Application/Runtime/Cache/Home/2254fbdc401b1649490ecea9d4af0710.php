...
$("#jdAdBtn").html(htmlAdBtn).find("a").powerSwitch({
	...
	<div class="mr"><!-- 主体右侧开始 -->
	<div class="mbrbt"><img src="/Test/Public/images/gsjj.gif" /></div>
	<div class="mrbtnr"><!-- 主体右侧内容开始 -->
	<div class="mrnr">
	
	<?php if(is_array($gsjj)): $i = 0; $__LIST__ = $gsjj;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; echo ($v["jj_content"]); endforeach; endif; else: echo "" ;endif; ?>
	</div>
    </div><!-- 主体右侧内容结束 -->
	</div><!-- 主体右侧结束 -->
	</div><!-- 主体内容结束 -->
